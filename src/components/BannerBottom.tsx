    ...
    <div className="w-full desktop:px-0 laptop:px-0 mt-6 laptop:mt-0 desktop:mt-0">
      <div className="grid grid-cols-2 gap-[20px]">
        {cards.map((card) => (
          <a
            key={card.id}
            className={`social-media-card cursor-pointer flex justify-center items-center rounded-2xl h-32 laptop:h-48 desktop:h-52 border border-[var(--color-tertiary)]`}
